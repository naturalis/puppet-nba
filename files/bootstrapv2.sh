...
git clone https://github.com/elastic/puppet-elasticsearch /etc/puppet/modules/elasticsearch -b 0.14.0
...
git clone https://github.com/biemond/biemond-wildfly /etc/puppet/modules/wildfly -b v0.5.7
